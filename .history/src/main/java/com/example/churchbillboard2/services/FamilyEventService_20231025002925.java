...
public class FamilyEventService {
    ...
    public ArrayList<FamilyEvent> getFamilyEventsByDateWithEventType(int month) {
        ...
        String firstDayOfMonthFormatted = sdf.format(firstDayOfMonth);
        String lastDayOfMonthFormatted = sdf2.format(lastDayOfMonth);
        System.out.println("lastDayOfMonthFormatted");
        System.out.println(lastDayOfMonthFormatted);
        // return belowGetFamilyEventsByDateWithEventType(firstDayOfMonthFormatted, lastDayOfMonthFormatted);
        return belowGetFamilyEventsByDateWithEventType(firstDayOfMonthFormatted, lastDayOfMonthFormatted);
    }
