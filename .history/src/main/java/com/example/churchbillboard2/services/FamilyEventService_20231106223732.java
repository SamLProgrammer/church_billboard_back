...
public class FamilyEventService {
    ...
    private Date turnIntoDate(String dateString) {
        ...
        System.out.println(dateString);
        String truncatedDateString = dateString.substring(1, dateString.length()-1);
        System.out.println(truncatedDateString);
        LocalDate localDate = LocalDate.parse(dateString.substring(1, dateString.length()-1));
