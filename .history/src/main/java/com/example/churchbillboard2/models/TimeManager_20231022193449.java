...
public class TimeManager {
    ...
    public String availableMonths(int currentMonth) {
        ...
        monthsMap.put(11, "Diciember");

        int index = 0;
        ArrayList<String> monthsList = new ArrayList<String>();
        // String[] monthsList = new String[(currentMonth != 12) ? currentMonth+1 : currentMonth];
        while(index < ((currentMonth != 12) ? currentMonth+1 : currentMonth)) {
            monthsList.add(monthsMap.get(index));
            index++;
        }
