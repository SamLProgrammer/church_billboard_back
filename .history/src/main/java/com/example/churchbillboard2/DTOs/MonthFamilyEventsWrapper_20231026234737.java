...
public class MonthFamilyEventsWrapper {
    ...
    public MonthFamilyEventsWrapper(ArrayList<Date> sundaysList, Boolean empty) {
        this.sundaysList = sundaysList;
        this.empty = empty;
    }

    public MonthFamilyEventsWrapper(ArrayList<Date> sundaysList, List<FamilyEventDTO> supperList, List<FamilyEventDTO> snackList) {
        this.sundaysList = sundaysList;
