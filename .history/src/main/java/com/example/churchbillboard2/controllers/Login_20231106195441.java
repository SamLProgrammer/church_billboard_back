...
public class Login {
    ...
    public String postMethodName(@RequestBody ArrayList<FamilyEvent> newFamilyEventsList) {
        for (FamilyEvent familyEvent : newFamilyEventsList) {
            System.out.println(familyEvent.getFamily() + " :: " + familyEvent.getFamilyEventType().getId());
        }
        return "all nice";
    }
    // try {
