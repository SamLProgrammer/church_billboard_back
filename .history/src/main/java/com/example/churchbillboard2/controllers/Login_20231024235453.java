...
public class Login {
    ...
    public ArrayList<FamilyEvent> postMethodName(@RequestHeader("CustomAuth") String headerValue, @RequestBody String month) {
        return (sessionTokenWrapper.validateToken(headerValue)) ? new FamilyEventsWrapper(null):;
    }
