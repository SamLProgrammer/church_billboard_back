...
public class FamilyEventService {
    ...
    public ArrayList<FamilyEvent> getFamilyEventsByDateWithEventType(Date date1, Date date2) {
        return familyEventRepository.findBetweenDatesWithEventType(date1, date2);
    }
}
