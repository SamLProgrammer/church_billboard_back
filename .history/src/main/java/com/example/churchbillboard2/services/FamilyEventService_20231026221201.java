...
public class FamilyEventService {
    ...
    public ArrayList<Object> getFamilyEventsByDateWithEventType(int month) {
    ...
    private ArrayList<FamilyEventDTO2> belowGetFamilyEventsByDateWithEventType(String startDate, String endDate) {
