...
public class FamilyEventService {
    ...
    public ArrayList<FamilyEvent> getFamilyEventsByDateWithEventType(Date date, Date date2) {
        return familyEventRepository.findBetweenDatesWithEventType(date, date2);
    }
}
